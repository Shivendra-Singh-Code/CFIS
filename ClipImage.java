...
class ClipImageAnand extends JFrame implements ActionListener
{
  ...
  ClipImageAnand()
  {
	...
	try
	{
		...
		cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/database1","root","king1234");
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		if(evt.getSource()==btnHair)
		{
			 ...
			 try
			 {
				FileOutputStream fout=new FileOutputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\hair"+selcrimid+".gif");
		...
		if(evt.getSource()==btnEyes)
		{
			 ...
			 lblEyes.setIcon(new ImageIcon(clipimg));
			  try
			 {
				FileOutputStream fout=new FileOutputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\eyes"+selcrimid+".gif");
				DataOutputStream dout=new DataOutputStream(fout);
				for(int i=0;i<pixels.length;i++)
				{
					dout.writeInt(pixels[i]);
		 ...
		 if(evt.getSource()==btnForeHead)
		{
			 ...
			 lblForeHead.setIcon(new ImageIcon(clipimg));
			  try
			 {
				FileOutputStream fout=new FileOutputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\forehead"+selcrimid+".gif");
				DataOutputStream dout=new DataOutputStream(fout);
				for(int i=0;i<pixels.length;i++)
				{
					dout.writeInt(pixels[i]);
		 ...
		 if(evt.getSource()==btnNose)
		{
			 ...
			 lblNose.setIcon(new ImageIcon(clipimg));
			  try
			 {
				FileOutputStream fout=new FileOutputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\nose"+selcrimid+".gif");
				DataOutputStream dout=new DataOutputStream(fout);
				for(int i=0;i<pixels.length;i++)
				{
					dout.writeInt(pixels[i]);
		 ...
		 if(evt.getSource()==btnLips)
		{
			 ...
			 lblLips.setIcon(new ImageIcon(clipimg));
			  try
			 {
				FileOutputStream fout=new FileOutputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\lips"+selcrimid+".gif");
				DataOutputStream dout=new DataOutputStream(fout);
				for(int i=0;i<pixels.length;i++)
				{
					dout.writeInt(pixels[i]);
		 ...
		 if(evt.getSource()==btnChin)
		{
          ...
          try
			 {
				FileOutputStream fout=new FileOutputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\chin"+selcrimid+".gif");
				DataOutputStream dout=new DataOutputStream(fout);
				for(int i=0;i<pixels.length;i++)
				{
					dout.writeInt(pixels[i]);
		...
		{
			lblHair.setIcon(new ImageIcon("C:\\Users\\SHIVA\\Desktop\\CFIS\\Icons\\anand.bmp"));
		}
		if(evt.getSource()==clearForeHead)
		{
			lblForeHead.setIcon(new ImageIcon("C:\\Users\\SHIVA\\Desktop\\CFIS\\Icons\\anand.bmp"));
		}
		if(evt.getSource()==clearEyes)
		{
			lblEyes.setIcon(new ImageIcon("C:\\Users\\SHIVA\\Desktop\\CFIS\\Icons\\anand.bmp"));
		}
		if(evt.getSource()==clearNose)
		{
			lblNose.setIcon(new ImageIcon("C:\\Users\\SHIVA\\Desktop\\CFIS\\Icons\\anand.bmp"));
		}
		if(evt.getSource()==clearLips)
		{
			lblLips.setIcon(new ImageIcon("C:\\Users\\SHIVA\\Desktop\\CFIS\\Icons\\anand.bmp"));
		}
		if(evt.getSource()==clearChin)
		{
			lblChin.setIcon(new ImageIcon("C:\\Users\\SHIVA\\Desktop\\CFIS\\Icons\\anand.bmp"));
		}
	...
	class SourceImageCanvas extends Canvas implements MouseListener
	{
			...
			public void paint(Graphics g)
		{
				if(imgstatus)
			{
					orgimg=tkt.getImage("C:\\Users\\SHIVA\\Desktop\\CFIS\\Images\\"+imgfile);
