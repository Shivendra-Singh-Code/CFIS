...
class Construct extends JFrame implements ActionListener
{
	...
	Construct()
	{
		...
		try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/database1","root","king1234");
			...
			while(rs.next())
		{
	        ...
	        FileInputStream hairfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\hair"+selcrimid+".gif");
			...
			ArrayList a2=new ArrayList();
                        FileInputStream fhfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\forehead"+selcrimid+".gif");
	        ...
	        FileInputStream eyesfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\eyes"+selcrimid+".gif");
			...
			FileInputStream nosefin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\nose"+selcrimid+".gif");
	        ...
	        FileInputStream lipsfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\lips"+selcrimid+".gif");
	        ...
	        FileInputStream chinfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\chin"+selcrimid+".gif");
	...
	public void writePhoto(int a[],int crid)
	{
		try
		{
		FileOutputStream suspectfout=new FileOutputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Suspects\\suspect"+crid+".gif");
		DataOutputStream suspectdout=new DataOutputStream(suspectfout);

		FileInputStream hairfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\hair"+cids[0]+".gif");
		DataInputStream hairdin=new DataInputStream(hairfin);
		while(hairfin.available()>0)
		{
		...
		FileInputStream fhfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\forehead"+cids[1]+".gif");
		DataInputStream fhdin=new DataInputStream(fhfin);
		while(fhfin.available()>0)
		{
        ...
        FileInputStream eyesfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\eyes"+cids[2]+".gif");
		DataInputStream eyesdin=new DataInputStream(eyesfin);
		while(eyesfin.available()>0)
		{
        ...
        FileInputStream lipsfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\lips"+cids[4]+".gif");
		DataInputStream lipsdin=new DataInputStream(lipsfin);
		while(lipsfin.available()>0)
		{
        ...
        FileInputStream chinfin=new FileInputStream("C:\\Users\\SHIVA\\Desktop\\CFIS\\Clips\\chin"+cids[5]+".gif");
		DataInputStream chindin=new DataInputStream(chinfin);
		while(chinfin.available()>0)
		{
