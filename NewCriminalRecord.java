...
class New extends JFrame implements ActionListener
{
	...
	New()
	{
		...
		public void actionPerformed(ActionEvent ae)
		{
			...
			//String str="insert into face(cid,fname,lname,aname,dob,age,gender,address,city,state,arresteddate,crimein,photo) values(" + cid + ",'" + firstname + "','" + lastname+ "','" + aliasname + "',to_date('" + dob + "-" + mob + "-" + yob + "','DD-MM-YYYY')," + age + ",'" + gender + "','" + address + "','" + city + "','" + state + "','" + arresteddate + "','" + crimeinvolved + "','" + photo + "')";
                        String str="INSERT INTO face(cid,fname,lname,aname,dob,age,gender,address,city,state,arresteddate,crimein,photo) VALUES('" + cid + "','" + firstname + "','" + lastname+ "','" + aliasname + "','" + dob + "','" + age + "','" + gender + "','" + address + "','" + city + "','" + state + "','" + arresteddate + "','" + crimeinvolved + "','" + photo + "')";
	...
	else if(b==b5)
	{
		...
		t11.setText("");
                t14.setText("");
		photo.setIcon(new ImageIcon("C:\\Users\\SHIVA\\Desktop\\CFIS\\Icons\\anand.bmp"));
